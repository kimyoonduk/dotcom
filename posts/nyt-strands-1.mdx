...
This post outlines the problem definition and formulation. Part 2 (coming soon) will describe the specific implementation details. The algorithm is available in a public github repo [here](https://github.com/kimyoonduk/nyt-puzzle-solver).
...
We benefit from our inherent semantic knowledge, a capability that our robotic counterparts have arguably yet to develop.[^1] 
...
Consider a big old box of jigsaw puzzles. If some of the pieces form a complete set, how do we find them?

Strands has a similar objective. Players must find combinations of word pieces that perfectly fit the rectangular game board.

By precomputing all possible words on our game board, we can prepare the set of puzzle pieces in advance. 
...
Reducing our puzzle to a known problem allows us to stand on the shoulders of giants from the past.
...
When I was taking algorithms courses as aa student, "NP" used to feel like a death sentence.
...
In Part 2, I will detail the optimization tactics I employed to improve the runtime from 10 hours to 10 seconds.[^3] 
